 ...
 * {@link ChatLogFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ChatLogFragment#newInstance} factory method to
...
public class ChatLogFragment extends Fragment {
    ...
    public static ChatLogFragment newInstance(int page, String title) {
        ChatLogFragment chatLogFragment = new ChatLogFragment();
        Bundle args = new Bundle();
        args.putInt("pageNumber", page);
        args.putString("pageTitle", title);
        chatLogFragment.setArguments(args);
